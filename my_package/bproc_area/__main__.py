...
if __name__ == "__main__":
    ...
    onto_path.append(pathlib.Path(path_to_package) / "custom_code" / "generation_components")
    path_to_onto_classes = pathlib.Path(path_to_package) / "custom_code" / "generation_components" / "main.owl"
