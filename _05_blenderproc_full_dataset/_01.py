...
parser.add_argument('--bop_parent_path', default="a", help="Path to the bop datasets parent directory")
parser.add_argument('--cc_textures_path', default="textures", help="Path to downloaded cc textures") # resources/cctextures
